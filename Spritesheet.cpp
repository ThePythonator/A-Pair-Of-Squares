...
void Spritesheet::sprite_scaled(uint8_t index, float x, float y) {
	// Render sprite at index from texture to screen
	sprite(index, x, y, scale);
}

void Spritesheet::sprite_scaled(uint8_t index, float x, float y, float angle, SDL_Point* center, SDL_RendererFlip flip) {
	// Render sprite at index from texture to screen
